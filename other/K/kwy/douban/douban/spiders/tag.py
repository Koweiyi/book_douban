...
# import sys
# sys.path.append('E:/Desktop/team06/tjpu06/other/K/kwy/douban/douban')
...
class TagSpider(scrapy.Spider):
    ...
    custom_settings = {
        'ITEM_PIPELINES': {'douban.pipelines.TagItemPipeline': 100}
    }
    ...
    def parse(self, response):
        ...
        for tag in tag_list:
            try:
                ...
                elif tag.text != '所有热门标签' and tag.text != '分类浏览' and response.url == 'https://book.douban.com/tag' \
                                                                                     '/?view=cloud':
                    item = Tag(
                        tag_name=tag.text,
                        tag_isHot=1
